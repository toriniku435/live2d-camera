...
#include "../modules/cubism/LAppMinimumDelegate.hpp"
#include "../modules/cubism/LAppPal.hpp"
...
jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass clazz = env->FindClass("com/live2d/camera/infrastructure/cubism/JniBridgeJava");
...
extern "C"
{
    ...
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnStart(JNIEnv *env, jclass type)
    {
        LAppMinimumDelegate::GetInstance()->OnStart();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnPause(JNIEnv *env, jclass type)
    {
        LAppMinimumDelegate::GetInstance()->OnPause();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnStop(JNIEnv *env, jclass type)
    {
        LAppMinimumDelegate::GetInstance()->OnStop();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnDestroy(JNIEnv *env, jclass type)
    {
        LAppMinimumDelegate::GetInstance()->OnDestroy();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnSurfaceCreated(JNIEnv *env, jclass type)
    {
        LAppMinimumDelegate::GetInstance()->OnSurfaceCreate();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnSurfaceChanged(JNIEnv *env, jclass type, jint width, jint height)
    {
        LAppMinimumDelegate::GetInstance()->OnSurfaceChanged(width, height);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnDrawFrame(JNIEnv *env, jclass type)
    {
        LAppMinimumDelegate::GetInstance()->Run();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnTouchesBegan(JNIEnv *env, jclass type, jfloat pointX, jfloat pointY)
    {
        LAppMinimumDelegate::GetInstance()->OnTouchBegan(pointX, pointY);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnTouchesEnded(JNIEnv *env, jclass type, jfloat pointX, jfloat pointY)
    {
        LAppMinimumDelegate::GetInstance()->OnTouchEnded(pointX, pointY);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_camera_infrastructure_cubism_JniBridgeJava_nativeOnTouchesMoved(JNIEnv *env, jclass type, jfloat pointX, jfloat pointY)
    {
